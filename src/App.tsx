...
import { CheckCircle2, Circle, BellDot, BellOff, Clock, Activity, BarChart3, Timer, Volume2, VolumeX, CalendarDays, Edit2 } from 'lucide-react';
                ...
                {Array.from({ length: 7 }).map((_, i) => {
                    ...
                    return (
                        <button
                            ...
                            className={cn(
                                "flex-shrink-0 flex flex-col items-center justify-center p-4 rounded-2xl border min-w-[120px] transition-all snap-center",
                                isSelected 
                        ...
                        >
                            ...
                            <span className="text-2xl font-bold mt-1">{format(targetDate, 'dd')}</span>
                            <span className={cn("text-xs mt-1", isSelected ? "text-indigo-100" : "text-gray-500")}>{format(targetDate, 'MMM yyyy', { locale: id })}</span>
                        </button>
                    )
                })}
            </div>
